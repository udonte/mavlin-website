          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div
                    className={`bg-gradient-to-br ${info.color} backdrop-blur-sm rounded-xl border border-white/10 p-6 transition-all duration-300 hover:border-blue-500/30 hover:shadow-xl`}
                  >
            ...
            <div className="flex flex-col md:flex-wrap items-center gap-2 w-full">
              {/* Business Hours */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm rounded-xl border border-white/10 p-6 w-full md:w-1/2"
              >
              ...
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl group w-full md:w-1/2"
              >
                <div
