...
const mockData = [
  { id: 1, title: "Advanced Decor", image: BoxImage4 },
  { id: 2, title: "Advanced Decor", image: BoxImage5 },
  { id: 3, title: "Advanced Decor", image: BoxImage6 },
];

const AdvancedFloors = () => {
  return (
